...
Como ejemplo para este ejercicio vamos a tomar la base de datos de [Global School-Based Student Health Survey](https://extranet.who.int/ncdsmicrodata/index.php/catalog/GSHS)
...
Siempre es bueno empezar haciendo una exploración de los datos, para eso podemos usar el comando glimpse().
...
Aunque antes de hacerlo vamos a explicar uno de los commandos más útiles en R.
A medida que los scripts se hacer más extensos es dificil empezar a seguir las operaciones que le hacemos a un dataframe. 
...
El pipe se utiliza para dar "foco" a las acciones que se hacen a un objeto. 
...
Vemos como las funciones ya tienen nombres más claros (únicamente para algunas variables ya que son las que vamos a necesitar), y podemos seguir con la transformación de nuestros datos.
Aquí hay otras funciones que nos podrían ayudar si quisieramos quitar los NAs o hacer otro tipo de transformaciones, pero en este caos vamos a utilizar todos los datos.
